      ...
      <div className="grid grid-cols-2 gap-3 text-sm">
        <div>
          ...
          <ul className="space-y-1">
            <li><Link href="/menu#profile" className="text-gray-600 hover:text-yellow-700">My Profile</Link></li>
            <li><Link href="/menu#orders" className="text-gray-600 hover:text-yellow-700">My Orders</Link></li>
            <li><Link href="/menu#wallet" className="text-gray-600 hover:text-yellow-700">Wallet Balance</Link></li>
          </ul>
        </div>
        <div>
          <p className="font-medium mb-1">Services</p>
          <ul className="space-y-1">
            <li><Link href="/menu#bulk" className="text-gray-600 hover:text-yellow-700">Bulk Order Query</Link></li>
          </ul>
        </div>
        <div>
          <p className="font-medium mb-1">Help & Support</p>
          <ul className="space-y-1">
            <li><Link href="/menu#contact" className="text-gray-600 hover:text-yellow-700">Contact Us</Link></li>
            <li><Link href="/menu#feedback" className="text-gray-600 hover:text-yellow-700">Feedback</Link></li>
          </ul>
        </div>
        <div>
          ...
          <ul className="space-y-1">
            ...
            <li><Link href="/menu#cancel" className="text-gray-600 hover:text-yellow-700">Cancellation Policy</Link></li>
          </ul>
        </div>
      </div>
