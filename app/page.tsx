  ...
  return (
    <main className="flex flex-col items-center justify-center p-6">
      <div className="text-center">
        <img src="/logo.png" alt="RailEats Logo" className="w-32 mx-auto mb-4"/>
      ...
      {result && (
        <div className="mt-10 w-full max-w-md bg-white p-4 rounded shadow text-black">
          ...
          <pre className="text-xs text-left whitespace-pre-wrap">{JSON.stringify(result.data, null, 2)}</pre>
        </div>
      )}
    </main>
  )
